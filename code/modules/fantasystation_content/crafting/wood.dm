GLOBAL_LIST_INIT(log_recipes, list(
	new/datum/stack_recipe("palisade", /obj/structure/railing/fantasy_palisade, 2, time = 5 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_CHECK_DIRECTION, category = CAT_STRUCTURE),
))

GLOBAL_LIST_INIT(swamp_log_recipes, list(
	new/datum/stack_recipe("palisade", /obj/structure/railing/fantasy_palisade/swamp, 2, time = 5 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_CHECK_DIRECTION, category = CAT_STRUCTURE),
))
